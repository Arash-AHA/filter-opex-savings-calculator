          ...
          {isMobile && (
            <div className="flex flex-col mt-2">
              <input
                ...
                min={0}
              />
              <span className="inline-flex items-center justify-center px-2 py-2 text-sm text-gray-500 bg-gray-50 border border-gray-200 rounded-md mt-1 whitespace-nowrap">
                Inches&nbsp;W.G.
              </span>
            </div>
          )}

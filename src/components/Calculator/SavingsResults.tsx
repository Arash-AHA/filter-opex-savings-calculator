...
interface SavingsResultsProps {
  ...
  bagPrice: number; // Add bagPrice prop
  cagePrice: number; // Add cagePrice prop
  totalBags: number; // Add totalBags prop
}
...
const SavingsResults: React.FC<SavingsResultsProps> = ({
  ...
  bagLength,
  formattedResults,
  bagPrice, // Add bagPrice prop
  cagePrice, // Add cagePrice prop
  totalBags // Add totalBags prop
}) => {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div className="lg:col-span-3 mt-6">
        ...
        <YearlySavingsGraph 
          ...
          bagPrice={bagPrice} // Pass bagPrice prop
          cagePrice={cagePrice} // Pass cagePrice prop
          totalBags={totalBags} // Pass totalBags prop
        />
      </div>
    </div>

          ...
          <CalculatorSection 
            title={
              ...
              >
                ...
                <ChevronDown 
                  className={`h-4 w-4 transition-transform ${openSections.bagReplacement ? 'transform rotate-180' : ''}`} 
                />
              </CollapsibleTrigger>
            } 
            delay={300} 
          ...
          <CalculatorSection 
            title={
              ...
              >
                ...
                <ChevronDown 
                  className={`h-4 w-4 transition-transform ${openSections.operational ? 'transform rotate-180' : ''}`} 
                />
              </CollapsibleTrigger>
            } 
            delay={500} 
          ...
          <CalculatorSection 
            title={
              ...
              >
                ...
                <ChevronDown 
                  className={`h-4 w-4 transition-transform ${openSections.savings ? 'transform rotate-180' : ''}`} 
                />
              </CollapsibleTrigger>
            } 
            delay={700} 
